...
{
    internal class SocketOutput : ISocketOutput
    {
        ...
        private readonly EventThread _thread;
        ...
        void ISocketOutput.Write(ArraySegment<byte> buffer)
        {
            WriteAsync(buffer, default(CancellationToken), isSync: true).GetAwaiter().GetResult();
        }
    ...
    {
        /// <summary>
        /// Synchronously writes a buffer to the socket.
        /// </summary>
        /// <param name="buffer"></param>
        void Write(ArraySegment<byte> buffer);

        /// <summary>
        /// Asynchronously writes a buffer to the socket.
        /// </summary>
        /// <param name="buffer"></param>
        /// <param name="cancellationToken"></param>
        /// <returns></returns>
        Task WriteAsync(ArraySegment<byte> buffer, CancellationToken cancellationToken = default(CancellationToken));

...
func (_m *brokerMock) NumPeers() int {
	ret := _m.Called()
...
func (_m *brokerMock) Publish(_a0 *message.Message, _a1 func(message.Subscriber) bool) int64 {
...
func (_m *brokerMock) Subscribe(_a0 message.Subscriber, _a1 *event.Subscription) bool {
	ret := _m.Called(_a0, _a1)
